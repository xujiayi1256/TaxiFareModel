...
from TaxiFareModel.trainer import download_model_from_gcp

PATH_TO_LOCAL_MODEL = 'model.joblib'
PATH_TO_ONLINE_MODEL = 'gs://wagon-data-842-jiayi/models/taxifaremodel/model.joblib'
...
def get_model(model="local"):
    if model == "google":
        pipeline = download_model_from_gcp()
    else:
